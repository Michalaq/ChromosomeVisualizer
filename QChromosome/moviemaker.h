...
{
void captureScene(int fbeg, int fend, Simulation* simulation, Viewport* viewport, const Camera* camera, QString suffix, int fr);
void captureScene1(int fn, Simulation* simulation, Viewport* viewport, const Camera* camera, QString suffix);
